...
contract CrowdFundEasy {
     ...
     */
    function getContribution(uint256 _id, address _contributor) public view returns (uint256 a) {
        unchecked {
            a = contributions[(_id << 160) + uint160(_contributor)] * price; //token.getTokenPriceInUSD();
        }
    }
